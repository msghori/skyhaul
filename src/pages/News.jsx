  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Stay updated with the latest logistics industry news, insights, and trends from Skyhaul. Expert articles on freight, supply chain, and global logistics." />
      </Helmet>
      ...
      <section className="relative bg-skyblue pt-32 pb-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl sm:text-5xl font-extrabold text-white mb-4 animate-fade-in-up">News & Insights</h1>
          <p className="text-white/80 text-lg max-w-xl mx-auto animate-fade-in-up animation-delay-200">
            Stay informed with the latest trends, insights, and updates from the world of logistics.
          </p>
        </div>
      </section>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
      ...
      <div>
        <div className="flex items-center gap-3 mb-4">
          <span className="px-3 py-1 bg-skyblue text-white text-xs font-bold rounded-full">{category}</span>
          <span className="text-navy-400 text-sm">{date}</span>
        </div>
        <h2 className="text-2xl sm:text-3xl font-extrabold text-navy-900 mb-4">{title}</h2>
